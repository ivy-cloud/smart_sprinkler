...
CLI: python3 scripts/fetch_weather.py --city "San Jose"
Library: from fetch_weather import load_forecast
"""
...
def main() -> int:
    ...
    parser.add_argument(
        "--with-schedule",
        action="store_true",
        help="Include sprinkler ON/OFF and duration (calls sprinkler_schedule logic)",
    )
    ...
    try:
        ...
        schedule_block: dict[str, Any] | None = None
        if args.with_schedule:
            from sprinkler_schedule import decide_sprinkler  # noqa: WPS433
            ...
            schedule_block = {
                ...
                "humidity_band": decision.humidity_band,
            }
        ...
        print(f"  Humidity avg/min/max: {summary['humidity_avg_pct']}% / "
